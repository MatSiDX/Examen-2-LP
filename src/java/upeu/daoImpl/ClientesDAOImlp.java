...
private PreparedStatement ps;
    ...
    @Override
    public List<Clientes> readAll() {String SQL = "SELECT c.idcliente, c.direccion, c.hobby, c.correo, c.idpersona, p.nombres from clientes c join personas p on c.idpersona = p.idpersona";
